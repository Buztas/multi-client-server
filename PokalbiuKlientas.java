...
public class PokalbiuKlientas {
    ...
    private void run() throws IOException {
        ...
        while (true) {
            ...
            } else if (tekstas.startsWith("#?")) {
                // Do nothing here; actual handling is below
            } else if (tekstas.equals("END_OF_MESSAGES")) {
                System.out.println("End of messages.");
            } else if (tekstas.equals("No messages found.")) {
                pranesimuSritis.append("No messages found.\n");
            } else {
                pranesimuSritis.append(tekstas + "\n"); // This handles the normal message and "#?" response
            }
        }
    }
